...
const FAQ_ITEMS = [
  {
    ...
    a: "Закрытый круглый стол предназначен для представителей ИТ-компаний: вендоров, интеграторов, разработчиков ПО и поставщиков инфраструктурных решений. Формат B2G — не для частных лиц и студентов.",
  },
  {
