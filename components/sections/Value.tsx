...
const BENEFITS = [
  "Технологический роадмэп ТГУ на 2027 — конкретные задачи и направления",
  "Прямой контакт с лицами, подписывающими контракты на ИТ-закупки",
  "Понимание бюджетных приоритетов до выхода тендеров",
  "Возможность предложить релевантные решения на ранней стадии",
  "Запись сессии и презентационные материалы для команды",
];
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <SectionTitle
              ...
              subtitle="Не networking ради networking — а конкретные коммерческие и стратегические активы для работы с одним из крупнейших вузов страны."
              accent
              align="left"
            />
