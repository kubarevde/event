...
const REASONS = [
  ...
  },
  {
    ...
    text: "Встреча с представителями ТГУ в формате доверительной сессии, а не через общий email или тендер на поздней стадии.",
  },
  {
    icon: Briefcase,
    title: "Коммерческий фокус",
    text: "Сессия создана для sales, аккаунтов и коммерческих директоров — с языком бизнеса, а не только технических спецификаций.",
  },
  {
    icon: Shield,
